...
public class Main {
    ...
    //Controlller -> holds the business logic. Holds the implementation of the commands
    //Repository -> хранилище. Там пазим обекти
    //Driver, Car, Race -> обекти.
    //Engine -> създава всичко и стартира задачата
}
