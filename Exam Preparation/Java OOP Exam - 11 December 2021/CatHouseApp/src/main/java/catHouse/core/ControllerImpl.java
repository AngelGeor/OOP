...
public class ControllerImpl implements Controller{
    ...
    public String toyForHouse(String houseName, String toyType) {
        ...
        return String.format(ConstantMessages.SUCCESSFULLY_ADDED_CAT_IN_HOUSE,toyType,houseName);
    }

    private House getHouseByName(String houseName) { // suzdavame tozi metod da moje da vzemem tochnata kushta
        // ot spisaka po ime:
    ...
    public String addCat(String houseName, String catType, String catName, String catBreed, double price) {
        ...
        //2. Namirane kushtata s dadenoto ime:
        House house = getHouseByName(houseName);

        //3. Dobavqme kotkata v kushtata
    ...
    public String sumOfAll(String houseName) {
        ...
        return String.format(ConstantMessages.VALUE_HOUSE, house.getName(),priceAll);
    }
