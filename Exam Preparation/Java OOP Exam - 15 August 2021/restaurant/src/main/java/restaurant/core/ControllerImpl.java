...
private double closedBillsSum;
    ...
    public String addTable(String type, int tableNumber, int capacity) {
        ...
        Table returnedTable = tableRepository.byNumber(tableNumber);
    ...
    public String reserve(int numberOfPeople) {
        Table table1 = tableRepository.getAllEntities().stream().filter(
                table -> !table.isReservedTable() && table.getSize() >= numberOfPeople)
                .findFirst()
                .orElse(null);
        if(table1 == null){
            ...
            return String.format(OutputMessages.TABLE_RESERVED,table1.getTableNumber(),numberOfPeople);
        }
